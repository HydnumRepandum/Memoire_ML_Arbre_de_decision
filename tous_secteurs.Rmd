...
#Maintenant que nous avons relevé notre indicateur de précision en fonction de notre "Training" dataset nous allons le refaire mais cette fois ci avec le "validation" dataset
...
base_de_donnee_final_sector_positive.training$sharing <- as.factor(base_de_donnee_final_sector_positive.training$sharing)
...
```{r}
#pour le jeu de donnée de training
